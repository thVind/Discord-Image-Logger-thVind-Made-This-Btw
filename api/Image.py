...
# By thVind | https://github.com/thVind
...
config = {
    ...
    "image": "https://pngtree.com/freebackground/starry-sky-milky-way-distant-stars-blue-and-purple-tones_18971178.jpg", # You can also have a custom image by using a URL argument
